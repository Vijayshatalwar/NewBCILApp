...
namespace MOXA_CSharp_MXIO
{
    class ioLogik
    {
        ...
        //===================================================================
        public static void CheckErr(int iRet, string szFunctionName, string MoxaIP)
        {
            try
            {
                ...
                if (iRet != MXIO_CS.MXIO_OK)
                {
                    ...
                    {
                        MessageBox.Show("The connection of application with Moxa Device IP " + MoxaIP + " not properly, Kindly check all the possibilities");
                        VariableInfo.mAppLog.LogMessage(BcilLib.EventNotice.EventTypes.evtInfo, "CheckMoxaConnection", "The connection of application with Moxa Device IP " + MoxaIP + "  not properly, Kindly check all the possibilities");
                        MXIO_CS.MXEIO_Exit();
        ...
        public void EthernetDIRead_Main(string MoxaIP)
        {
            try
            {
                ...
                string Password = "";
                UInt32 Timeout = Convert.ToUInt32(GreenplyCommServer.Properties.Settings.Default.Moxa_Timeout);
                UInt32 i;
                //UInt16 wIndex;
                //UInt32 uiGetInput = 0;
                {
                    ...
                    CheckErr(ret, "MXEIO_E1K_Connect", MoxaIP);
                    ...
                    CheckErr(ret, "MXEIO_CheckConnection", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    {
                    ...
                    CheckErr(ret, "MXIO_ReadFirmwareRevision", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    ...
                    CheckErr(ret, "MXIO_ReadFirmwareDate", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    ...
                    CheckErr(ret, "MXIO_GetModuleType", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    ...
                    CheckErr(ret, "E1K_DI_SetModes", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    ...
                    CheckErr(ret, "E1K_DI_GetModes", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    {
                    ...
                    CheckErr(ret, "E1K_DI_SetFilters", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    ...
                    CheckErr(ret, "E1K_DI_GetFilters", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    {
                    ...
                    CheckErr(ret, "E1K_DI_Reads", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
                    {
                    ...
                    CheckErr(ret, "MXEIO_Disconnect", MoxaIP);
                    if (ret == MXIO_CS.MXIO_OK)
