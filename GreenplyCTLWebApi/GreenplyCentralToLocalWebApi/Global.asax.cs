...
namespace GreenplyCentralToLocalWebApi
{
    public class WebApiApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            //{
            //    _dir.Create();
            //    System.IO.Directory.CreateDirectory(_dir.ToString() + "log\\");
            //}
            ...
            //_obj.LogFilesPrefix = "GreenplyC2LLog";
            //_obj.StartLogging();
    ...
    public class WriteLogFile
    {
        public void WriteLog(string strLog)
        {
            ...
            string logFilePath;
            logFilePath = AppDomain.CurrentDomain.BaseDirectory + "\\LogFiles\\" + "LogFile_" + System.DateTime.Today.ToString("dd-MM-yyyy") + "." + "txt";
            ...
            log.WriteLine("(CentralDataScheduler) : " + DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss") + " " + strLog);
            log.Close();
        }
    }
}
