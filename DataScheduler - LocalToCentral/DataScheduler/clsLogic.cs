...
namespace DataScheduler
{
    public class clsLogic
    {
        ...
        //                //ObjLog.WriteLog("Data Scheduler => fnPIGetMaterialMaster : Item Code : " + dr["ItemCode"] + " Description : " + dr["ItemDescription"] + " UOM : " + dr["UOM"] + " ");
        ...
        //    {
        //        ObjLog.WriteLog("fnPIGetMaterialMaster=>" + "PI Transaction Error :: " + exSap.Message.ToString());
        //    }
        ...
        //        {
        //            //ObjLog.WriteLog("Data Scheduler => fnPIGetStorageLocationMaster : Data received from SAP : Date : " + ds.Tables[0].Rows[0][0] + " Status : " + ds.Tables[0].Rows[0][1] + " No Of Records : " + response.TbStorageLocation.Length + " ");
        ...
        //                //ObjLog.WriteLog("Data Scheduler => fnPIGetStorageLocationMaster : Plant Code : " + dr["PLANT_CODE"] + " PLANT NAME : " + dr["NAME"] + " PLANT CITY : " + dr["CITY"] + " ");
        ...
        //    catch (Exception exSap)
        //    {
        //        ObjLog.WriteLog("fnPIGetStorageLocationMaster =>" + " PI Transaction Error => " + exSap.Message.ToString());
        //    }
        ...
        //        {
        //            //ObjLog.WriteLog("Data Scheduler => fnPIGetCostCenterMaster : Data received from SAP : Date : " + ds.Tables[0].Rows[0][0] + " Status : " + ds.Tables[0].Rows[0][1] + " No Of Records : " + response.TbCostCenter.Length + " ");
        //            ds.Tables[0].Columns.Add("PLANT_CODE");//
        ...
        //                dr["VENDOR_TYPE"] = Convert.ToString(Convert.ToString(items.VendorType) == null ? "" : Convert.ToString(items.VendorType));
        //                //ObjLog.WriteLog("Data Scheduler => fnPIGetCostCenterMaster : Plant Code : " + dr["PLANT_CODE"] + " PLANT NAME : " + dr["NAME"] + " PLANT CITY : " + dr["CITY"] + " ");
        //                ds.Tables[0].Rows.Add(dr);
        //            }
        //        }
        //    }
        ...
        //    catch (Exception exSap)
        //    {
        //        ObjLog.WriteLog("fnPIGetCostCenterMaster =>" + " PI Transaction Error => " + exSap.Message.ToString());
        //    }
